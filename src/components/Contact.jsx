...
function Contact() {
  ...
  return (
    <div
      id="contact"
      className="flex flex-col sm:flex-row justify-center items-center sm:mx-auto gap-x-7  text-gray-400 sm:w-3/4 py-12 mx-4 sm:py-28 mb-8 rounded-md shadow-md shadow-[#fb5c2c]"
    >
      <div className="flex flex-col justify-between items-center text-2xl sm:text-3xl font-extrabold sm:w-1/3">
        <span>
          Get in{" "}
          <span className=" sm:text-5xl font-extrabold text-[#fb5c2c]">
            touch!
          </span>
        </span>
        <br />
        <span className=" sm:text-2xl font-bold text-[#fb5c2c] mb-3">
          +973 17333375
        </span>
        ...
        <form className="flex flex-col " ref={form} onSubmit={sendEmail}>
          <Reveal>
            <h1 className=" text-7xl text-neutral-300 w-full  text-center mb-2 font-extrabold">
              Contact<span className=" text-[#fb5c2c]">.</span>
            </h1>
          </Reveal>
          ...
          <input
            ...
            className="w-full bg-[#fb5c2c] text-black cursor-pointer hover:bg-[#fb5c2c] hover:text-gray-300 transition duration-500 text-lg font-bold py-3 rounded-sm "
          />
