    ...
    <div id="technologies" className=" m-auto sm:w-2/3 w-4/5 sm:mt-24 pb-44 ">
      ...
      <div className="mt-10 w-full ">
        <Reveal>
          ...
          <span className="h-2 rounded-full w-4/5 bg-orange-400 block "></span>
          <div className=" flex justify-between font-bold mt-4">
        ...
        <span className="h-2 rounded-full w-[50%]  bg-orange-400 block"></span>
        <Reveal>
          <div className=" flex justify-between font-bold mt-4">
        ...
        <Reveal>
          ...
          <span className="h-2 rounded-full w-full bg-orange-400 block "></span>
        ...
        <div className="grid sm:grid-cols-3  gap-6 mt-3">
          <Reveal>
            <div className="flex flex-row justify-start items-center">
              <span className=" bg-orange-400 rounded-full h-4 w-4 block mx-2"></span>
